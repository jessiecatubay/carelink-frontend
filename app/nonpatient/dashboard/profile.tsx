...
import AccountStatus from "@/components/feature/nonpatient/settings/profile/AccountStatus";
      ...
      >
        ...
        <AccountStatus
          ...
          onEmailVerificationPress={() =>
            Alert.alert("Email Verification", "Your email is verified.")
          }
          onAccountStatusPress={() =>
            Alert.alert("Account Status", "Your account is active.")
          }
        />
