        ...
        <View style={styles.content}>
          ...
          <View style={styles.card}>
            <ScrollView showsVerticalScrollIndicator>
              ...
              <Text style={styles.body}>
                By accessing or using CareLink, you agree to be bound by these
              ...
              <Text style={styles.body}>
                CareLink is a patient assistance system that allows non-patients
                to receive alerts from connected hardware device and access
                AI-based guidance for responding to patient needs.
              </Text>
              ...
              <Text style={styles.body}>
                Your information is collected only to provide CareLink services
                and is protected according to our Privacy Policy.
              </Text>
            </ScrollView>
          </View>
